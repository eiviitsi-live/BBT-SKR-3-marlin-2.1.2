...
#define STRING_CONFIG_H_AUTHOR "(eiviitsi@live, SKR-3)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "eiviitsi@live SKR-3"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 1280, 1280, 400, 139, 139 }
...
//#define CLASSIC_JERK
  ...
  #define LIMITED_JERK_EDITING        // Limit edit via M205 or LCD to DEFAULT_aJERK * 2
    ...
    #define MAX_JERK_EDIT_VALUES { 6, 6, 0.6, 10 } // ...or, set your own edit limits
  #endif
#endif
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 34, -57, -1.80 }
...
#define PROBE_ENABLE_DISABLE
  ...
  #define PROBE_ENABLE_PIN PC13   // Override the default pin here
#endif
...
#define PRINTCOUNTER
  ...
  #define PRINTCOUNTER_SAVE_INTERVAL 20 // (minutes) EEPROM save interval during print. A value of 0 will save stats at end of print.
#endif
