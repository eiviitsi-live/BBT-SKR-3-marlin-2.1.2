...
#define USE_CONTROLLER_FAN
  ...
  #define CONTROLLERFAN_SPEED_ACTIVE     45 // (0-255) Active speed, used when any motor is enabled
...
#define COOLER_AUTO_FAN_TEMPERATURE 48
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 35*60, 35*60, 4*60, 4*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
...
//
  ...
  #define DGUS_UPDATE_INTERVAL_MS  500    // (ms) Interval between automatic screen updates
    ...
    #define DGUS_FILAMENT_LOADUNLOAD
      ...
      #define DGUS_FILAMENT_PURGE_LENGTH 1
...
#define LIN_ADVANCE
    ...
    #define ADVANCE_K { 0.55 }    // (mm) Compression length per 1mm/s extruder speed, per extruder
  #else
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_LENGTH   350  // (mm) Load length of filament, from extruder gear to nozzle.
                                                  //   For Bowden, the full length of the tube and nozzle.
                                                  //   For direct drive, the full length of the nozzle.
  #define ADVANCED_PAUSE_CONTINUOUS_PURGE     10  // Purge continuously up to the purge length until interrupted.
 ...
 * @section tmc/config
 */
#if HAS_TRINAMIC_CONFIG || HAS_TMC22X
